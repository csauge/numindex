...
export function generateResourceCardHTML(d: Resource, options: {
  ...
  if (d.cat === 'evenement' && d.next) {
    ...
    html += '<div class="absolute bottom-2 left-2 flex items-center gap-1 px-2 py-1 rounded-md text-[8px] font-black uppercase bg-white/90 text-stone-800 shadow-sm border border-stone-100">';
