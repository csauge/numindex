...
export const CATEGORIES: Record<CategoryKey, CategoryInfo> = {
  acteur: {
    ...
    mandatoryTags: ['Entreprise', 'Association', 'Institution', 'Coopérative', 'Collectif', 'Personne'],
    optionalTags: ['Local', 'ESS', 'B-Corp', 'Label NR', 'Media', 'Matériel', 'Hébergement', 'Service']
  },
  evenement: {
    fr: 'Événement',
    en: 'Event',
  ...
  outil: {
    ...
    mandatoryTags: ['Logiciel', 'Référentiel', 'Guide', 'Jeu', 'Formation', 'Atelier', 'Loi', 'Travail'],
    optionalTags: ['Open Source', 'Gratuit', 'Payant', 'Libre', 'Creative Commons', 'Mesure']
  }
};
